      ...
      <div className="section-style flex-col gap-4 md:gap-6 max-w-5xl">
        ...
        <section>
          ...
          <div>
            ...
            <section>
              <h3 className="section-subheader">Frontend</h3>
              <div className="flex gap-1 flex-wrap">
                <img
            ...
            <section>
              <h3 className="section-subheader">Backend</h3>
              <div className="flex gap-1 flex-wrap">
                <img
            ...
            <section>
              <h3 className="section-subheader">Database</h3>
              <div className="flex gap-1 flex-wrap">
                <img
            ...
            <section>
              <h3 className="section-subheader">Data Science</h3>
              <div className="flex gap-1 flex-wrap">
                <img
            ...
            <section>
              <h3 className="section-subheader">Others</h3>
              <div className="flex gap-1 flex-wrap">
                <img
