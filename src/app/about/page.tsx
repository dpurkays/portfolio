          ...
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-4 md:gap-6">
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              <p>
                ...
                and solve problems. But at some point, I felt lost—and that led
                me to revisit my lifelong passion for technology. Studying
              ...
              <p>
                What I enjoy most about this field is the constant
                evolution—there’s always something new to learn or improve.
                Whether it’s refining a user experience, fixing a tricky bug, or
                finding a more thoughtful way to approach a problem, I find joy
                in the process. I'm known for being detail-oriented, eager to
                grow, and motivated by the opportunity to turn ideas into
                something real.
              </p>
              <p>
